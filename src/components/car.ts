export default function getCarImgForRender(color: string): string {
  return `
...
export function getCarForRender({
  id,
  name,
  color,
  isEngineStarted,
      ...
      <div class="road">
        <div class="car-panel">
            <div class="control-panel">
              <button class="button icon start-engine-button" id="start-engine-car-${id}" ${
    isEngineStarted ? 'disabled' : ''
  }>A</button>
              <button class="button icon stop-engine-button" id="stop-engine-car-${id}" ${
    isEngineStarted ? 'disabled' : ''
  }>B</button>
            </div>
            <div class="car" id="car-${id}">
              ${getCarImgForRender(color)}
            </div>
        </div>
